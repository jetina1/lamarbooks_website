...
<div class="main-content">
    ...
    <p><strong>Name:</strong> <span id="category-name">{{ $category['name'] }}</span></p>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const categoryId = {{ $category['id'] }}; // Pass the category ID from Laravel to JavaScript

        // Fetch category data from Node.js API
        fetch(`https://lalmarbooks.onrender.com/categories/${categoryId}`)
            .then(response => response.json())
            .then(data => {
                // Handle the fetched data and update the page
                if (data) {
